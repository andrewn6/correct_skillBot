...
class Info(Cog):
    ...
    async def av(self, ctx, *, member: Optional[MemberConverter]):
    ...
    @command(name="userinfo", aliases=["memberinfo", 'ui', "mi", "whois"], brief="Returns Basic user info like pfp name id and date of joining")
    ...
    @command(name="serverinfo", aliases=["guildinfo", "si", "gi"], brief="Returns server info like member count owner and many more try to find out...")
